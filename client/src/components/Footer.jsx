...
function Footer() {
  return (
    <footer className="p-3 md:px-20 items-center rounded-md justify-center text-center">
      ...
      <aside className="pt-3">
        <p>
          ...
          <Link to="https://github.com/sujit-patel" className="font-bold font-serif text-pink-500 underline">
            sujit-patel
          </Link>
        </p>
      </aside>
