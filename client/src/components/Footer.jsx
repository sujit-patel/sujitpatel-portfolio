...
function Footer() {
  return (
    <footer className="p-3 md:px-20  rounded-md flex items-center justify-between">
      <aside className="">
        <p>
          Copyright &copy; 2025 Designed and Developed by{" "}
          <Link
            to="https://github.com/sujit-patel"
            className="font-bold font-serif text-pink-500 hover:text-pink-700 underline"
          >
            sujit-patel
          </Link>
        </p>
